...
[getting started](https://github.com/fastbean-au/hippocampus/blob/main/docs/getting-started.md)) and decay tuned to bite:
...
2. Trigger a consolidation cycle (`curl -s -X POST http://localhost:8080/v1/sleep -d '{}'`) and
   ...
   see [demonstrations](https://github.com/fastbean-au/hippocampus/blob/main/docs/demonstrations.md).)
